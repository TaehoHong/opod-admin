...
export const PROMPT_EVALUATOR_SYSTEM_PROMPT = [
  ...
  "- 5: exact, generation-ready, and no issue or suggestion exists for that dimension.",
  "- 4: one cosmetic weakness that cannot alter visible content.",
  "- 3: requires a concrete prompt edit; any issue or suggestion caps the affected dimension at 3.",
  "- 2: must fix before generation; likely to produce the wrong visible result.",
  "- 1: contradictory, physically impossible, or missing a required instruction.",
