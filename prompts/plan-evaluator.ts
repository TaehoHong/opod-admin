...
export const PLAN_EVALUATOR_SYSTEM_PROMPT = [
  ...
  "Mandatory caps:",
  "- Near-duplicate shots, contradictory capture mechanics, or a selected reference whose description conflicts with the planned framing score at most 2 in the affected dimension.",
  "- Do not penalize locationId being null when the requested place is not present in the supplied location catalog. In that case, judge location_coherence from the literal scene wording across shots. Penalize a missing location or environment reference only when a suitable catalog location is actually available or the shots contradict each other.",
